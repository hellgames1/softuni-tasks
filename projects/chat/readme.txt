Very simple (and easily hackable) chat program

The client side is the Python code, the server side is the PHP code.
For the PHP to function, it needs a chat.txt file and a users.txt file, both files containing the symbols @@
...
Много проста (и лесна за хакване) чат програма

Клиентската страна е Python кодът, докато сървърната страна е PHP кодът.
За да работи PHP-то, трябва да има в същата папка chat.txt файл и users.txt файл, и двата да съдържат @@
