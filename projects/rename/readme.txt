...
while the python file can be named anything. Of course, the program doesn't attempt to rename itself.
...
Python скрипта може да се казва както си искате. Разбира се, програмата не прави опит да преименува себе си.
